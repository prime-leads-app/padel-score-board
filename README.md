...
**Orden de saque:** los controles están en la parte izquierda del encabezado. El icono de flechas circulares cambia manualmente el equipo sacador con un toque y alterna entre sus dos jugadores con dos toques. El icono contiguo de posiciones intercambia izquierda/derecha a los jugadores del equipo sacador con un solo toque; el borde amarillo permanece en la posición de saque, por lo que el compañero que pasa a esa posición queda marcado y sus estadísticas se trasladan con él. Al terminar cada juego, el saque pasa al equipo contrario y queda preparado el compañero del equipo anterior para su siguiente turno; la secuencia predeterminada es equipo 1 izquierda, equipo 2 izquierda, equipo 1 derecha y equipo 2 derecha. **Deshacer** también restaura el equipo y jugador que sacaban antes del punto.
