...
**Orden de saque:** los controles están en la parte izquierda del encabezado y cada uno tiene una sola acción. Las flechas circulares cambian el equipo sacador; el icono de posiciones intercambia izquierda/derecha a los jugadores del equipo sacador sin mover el indicador de su posición física; el icono amarillo de persona, colocado en la cuarta posición contando el menú, cambia cuál de sus dos jugadores saca y mueve el borde amarillo al otro nombre. Al terminar cada juego, el saque pasa al equipo contrario y queda preparado el compañero del equipo anterior para su siguiente turno; la secuencia predeterminada es equipo 1 izquierda, equipo 2 izquierda, equipo 1 derecha y equipo 2 derecha. **Deshacer** también restaura el equipo y jugador que sacaban antes del punto.
...
**Encabezado:** ☰ menú · cambiar equipo sacador · intercambiar posiciones · cambiar jugador sacador · reloj · 👥 jugadores del partido · ⇄ cambiar los equipos de lado · 🏆 clasificación. Los tres últimos solo aparecen en Retas; Datos del partido está dentro del menú.
